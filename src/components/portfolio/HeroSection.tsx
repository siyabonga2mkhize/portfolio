...
export default function HeroSection({ isDark }: HeroSectionProps) {
  ...
  const roles = ["Full Stack Developer", "Cloud & Data Specialist", "Cybersecurity Enthusiast"];
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <p className={`text-lg md:text-xl max-w-3xl mx-auto leading-relaxed ${
            ...
            ICT Applications Development student with Oracle Cloud certifications, Cisco cybersecurity credentials, 
            and hands-on experience in full stack development. Let's build something impactful together.
          </p>
        </motion.div>
